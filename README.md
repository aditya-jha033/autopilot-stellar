...
| Drishya Debnath | `GDCP2LXKUNBHFV4FPG4SDRIIQ5WVJ2OWH7WJWBHOK5TCNXKSDI74O32G` | Testnet | 3 | 5 | 4 | It's like giving prompt and actually planning to save my money | Actually, there is no USDC support in AI or no suggestion and in main dashboard there is no mark of USDC other than that everything is fine | Just fix that USDC support that will be enough | Yes | `[PENDING]` |
...
| Murkat Keshri | `GCVODPBH7PNE6AENNEYO6PFDH3VSF5JKYH6ULN3ZICROIWYAGJWLXSJY` | Testnet | 3 | 5 | 4 | Vault Section | The thinking of simplying the investment is very nice I like this. | Yes while using it I found a bug that the ivestment vault graph is not working. | Yes | `[PENDING]` |
