...
| Rajesh Roshan | `GAXPJXWRLLZWRGJWYDWM7ZQ4RBV77CKRN6BZYPBK7IWLBB7MLUS6P2T3` | Testnet | 4 | 4 | 4 | I like all the features | I liek tit but I think after creating the rule a alert card need to be abuilt if vault is not created otherwise that trasnection will not be recorded right. | No such but the alert card will be very helpful for users | Yes | [`ae6647b`](https://github.com/aditya-jha033/autopilot-stellar/commit/ae6647b) |
| Rana Dutta | `GA7A4OHK55D3YRLLQJLIM7Y6R3TXGT45DPSHVSWRXLSUIDJSBTBTPWAW` | Testnet | 4 | 4 | 4 | Easy creation of profile in this app | alll fesatures are good especailly XLM and both USDC. | When edtiting rules there is only for XLM but not for USDC. | Yes | [`ae6647b`](https://github.com/aditya-jha033/autopilot-stellar/commit/ae6647b) |
| Titash Sen | `GC5J6BN4BXXNE6DR6OHJSRH4WH4EZEFIO4AM2KRNFZEA5DCI3QFKODKA` | Testnet | 4 | 5 | 3 | UI UX is good | Product is good | NA | Yes | [`ae6647b`](https://github.com/aditya-jha033/autopilot-stellar/commit/ae6647b) |
| Soumalya Sen | `GAJUWETQPUT4RH6BHWDQOMC6EPTMMW4Q3IW46KSMCZLN7Y25NCLQBOV3` | Testnet | 3 | 4 | 4 | Seperate Vault for savings and investment | Everything is rood but I opened it in mobile. | Mobile bottom nav overlaps page content checkthat and fix it | Yes | [`ae6647b`](https://github.com/aditya-jha033/autopilot-stellar/commit/ae6647b) |
