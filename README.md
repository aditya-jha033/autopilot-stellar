<div align="center">
  ...
  <p>
    <a href="https://github.com/aditya-jha033/autopilot-stellar/actions/workflows/frontend.yml"><img src="https://github.com/aditya-jha033/autopilot-stellar/actions/workflows/frontend.yml/badge.svg?branch=main" alt="Frontend CI" /></a>
    <a href="https://github.com/aditya-jha033/autopilot-stellar/actions/workflows/backend.yml"><img src="https://github.com/aditya-jha033/autopilot-stellar/actions/workflows/backend.yml/badge.svg?branch=main" alt="Backend CI" /></a>
    <a href="https://github.com/aditya-jha033/autopilot-stellar/actions/workflows/contract.yml"><img src="https://github.com/aditya-jha033/autopilot-stellar/actions/workflows/contract.yml/badge.svg?branch=main" alt="Contract CI" /></a>
    <a href="https://github.com/aditya-jha033/autopilot-stellar/actions/workflows/security.yml"><img src="https://github.com/aditya-jha033/autopilot-stellar/actions/workflows/security.yml/badge.svg?branch=main" alt="Security Audit" /></a>
  </p>
</div>
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| Pritam mondal | `GATJMD6BGNK4FQYNFWB354N7RP4XHA2R74GNSYM472ALNLJFX7NXBS3X` | Testnet | 5 | 5 | 4 | autopilot is crazy | Clean UI and very intuitive. I was able to understand the app within a minute. | imporvement of uiux and more enhance typograpghy needed | Yes | [`18a879d`](https://github.com/aditya-jha033/autopilot-stellar/commit/18a879d) |
| Sadiya Shakir Mulani | `GDN4FE5B27AQPIYWDI26QEH6JRF23QG65755NNLTFTGPPAS77EA25ZZP` | Testnet | 5 | 5 | 5 | AI-powered financial automation workflow | Great concept with a clean and intuitive UI. The automation flow is easy to understand and has strong real-world potential. | Adding clearer progress indicators and more detailed success/error messages would make the overall user experience even better. | Yes | [`18a879d`](https://github.com/aditya-jha033/autopilot-stellar/commit/18a879d) |
| Arya Bhagat | `GCNZDOHRGJLUKX53TR5PETCO7Q3BKKWVS5K5GQ3NPFZYQ4MKY2BK6A32` | Testnet | 4 | 5 | 5 | colour | its good | add a day night toggel | Yes | [`18a879d`](https://github.com/aditya-jha033/autopilot-stellar/commit/18a879d) |
...
| Karan | `GDX4565AJ4DBGP3HGDIV7F6QJ3IPOVDLG3BOXTHS5ITWKJMEWND3Y7HK` | Testnet | 5 | 5 | 5 | Automatic saving is a very cool feature | Good Product great idea but one thing is missing from here that is its landing page. | add a landing page | Yes | [`18a879d`](https://github.com/aditya-jha033/autopilot-stellar/commit/18a879d) |
| Drishya Debnath | `GDCP2LXKUNBHFV4FPG4SDRIIQ5WVJ2OWH7WJWBHOK5TCNXKSDI74O32G` | Testnet | 3 | 5 | 4 | It's like giving prompt and actually planning to save my money | Actually, there is no USDC support in AI or no suggestion and in main dashboard there is no mark of USDC other than that everything is fine | Just fix that USDC support that will be enough | Yes | [`1031e4f`](https://github.com/aditya-jha033/autopilot-stellar/commit/1031e4f) |
| Omkar Singh | `GCKCB3VVRFWTDIIQ6E2VFRIKCGE4CZEWHWZJCLWCPG37VGAPMKWNW4TW` | Testnet | 4 | 4 | 4 | Smooth transection and loading speed is good with very weel designed UI | Its really helpful product | Some times the valut is not storing the amount and sometimes it is storing pelase check and fix that issue | Yes | [`e74abca`](https://github.com/aditya-jha033/autopilot-stellar/commit/e74abca) |
| Sarthak Dhar | `GCCOAGPSAKD5E6ES2DIU64NXWG6O4M4HP5JXFMYLV3NR5SXOX2TCWEDQ` | Testnet | 4 | 4 | 5 | planning for my product | Its amazing product no complain I can plan my goals and save for wants here. | NA | Yes | |
| Viswajit Dey | `GAPVN4B4EYFBFR5GKKKAITUXPUWWZ7VQCWK7273A2MT46K7ZBA4ILITI` | Testnet | 4 | 5 | 4 | autopilot chat is very good I like how its is processing my raw text messages | the coach model is very helpful | the vault saving soemtimes not working please check that once and add a walkthough I did trnsection without creating a vault. | Yes | [`e74abca`](https://github.com/aditya-jha033/autopilot-stellar/commit/e74abca), [`18a879d`](https://github.com/aditya-jha033/autopilot-stellar/commit/18a879d) |
| Murkat Keshri | `GCVODPBH7PNE6AENNEYO6PFDH3VSF5JKYH6ULN3ZICROIWYAGJWLXSJY` | Testnet | 3 | 5 | 4 | Vault Section | The thinking of simplying the investment is very nice I like this. | Yes while using it I found a bug that the ivestment vault graph is not working. | Yes | [`2028004`](https://github.com/aditya-jha033/autopilot-stellar/commit/2028004) |
| Kushal Saha | `GDQJ7VPDOB247LD6D4QD6UQIYBKNVFU7UKNJGE55K77S23XMG77NEY33` | Testnet | 4 | 4 | 4 | Goal Section its helps to plan for my goal and saving info easily | Overall is good to have a paltform like this for saving and planning stuffs. | Na | Yes | |
| Sumana Mukherjee | `GC2Q4MY3MWAV4TUVXXTYPPHC2OV55E7HNRDDMGD4VMOQLQKJGQRGSW3B` | Testnet | 3 | 4 | 4 | all things are good and polished well | overall I like the idea great initiative | No its working good for me | Yes | |
| Sandeep Kumar | `GAVNKQJQH67HIDKS3VQVWQJKWO5CYO3INGXS7Y3NJBBM42L4QFU7NZ4X` | Testnet | 5 | 5 | 4 | All the features are good. | ITs good animation are well decorated | No | Yes | |
| Rajkumar Singha | `GD37TTSTX22Y24CAKWO45IKKHEMDYVEK7MEE7QC6C4O6VAIDXCEK4VL4` | Testnet | 5 | 4 | 4 | I did many transection and it helped me to save a lot of money | While doing many trasnection the portfolio page got longer | I want you to fix the this long scrolling the porfile limit it by last 5 trsnection to be shown adn keep a more topion to check it all. | Yes | [`cc4b9df`](https://github.com/aditya-jha033/autopilot-stellar/commit/cc4b9df) |
| Parvesh Sapru | `GC22Z2IN3ROLZFW3JEU64C4IZZ74Z5RZWOG4OO64FJPKNMS77GZGVBMA` | Testnet | 5 | 4 | 5 | everything is cool | Speed of the AI model is good | Na | Yes | |
| Riju Roy | `GALKUNV3QKBIP37JCQXXDOCZBRKBCA52JRCOH2442GHSRHOWG3RPPWTL` | Testnet | 4 | 5 | 4 | I like this Autopilot chatting feature and editing option | Product Idea is great and automation is working nicely | I think the Buffer is not wokring properly please check it once it is not storing anywhere. | Yes | [`1373f0d`](https://github.com/aditya-jha033/autopilot-stellar/commit/1373f0d) |
| Joydeep Santra | `GBQWJUMYCSE63MT2XBAYK4BMMAJJFNTOR46QGPST4BLSPWBNGLU6FFHD` | Testnet | 4 | 5 | 5 | The seprate saving panel for savings and investement is good to store and monitor it separately. | I like the product. It will help people to save some through automation. | No | Yes | [`ae6647b`](https://github.com/aditya-jha033/autopilot-stellar/commit/ae6647b) |
| Rajesh Roshan | `GAXPJXWRLLZWRGJWYDWM7ZQ4RBV77CKRN6BZYPBK7IWLBB7MLUS6P2T3` | Testnet | 4 | 4 | 4 | I like all the features | I liek tit but I think after creating the rule a alert card need to be abuilt if vault is not created otherwise that trasnection will not be recorded right. | No such but the alert card will be very helpful for users | Yes | [`0c2901e`](https://github.com/aditya-jha033/autopilot-stellar/commit/0c2901e) |
